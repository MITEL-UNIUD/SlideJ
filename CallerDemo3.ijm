/////////////////////////////////////////////////////////
// SlideJ CallerDemo3 macro                            //
//                                                     //
// It calls SlideJ with SlideDemo3 macro               //
// to activate Batch mode before any other operation.  //
// It also renames the ImmunoRatio Results table to    //
// have it available after execution.                  //  
...
callit="/Users/enzo/Documents/lavori/AIDPATH/SlideJ/github/SlideJdemo3.ijm";

run("SlideJ ", "input="+in+" output="+out+" macro="+callit+" series=1 tile=8192 overlap=0 cancel=No");
...
addVariable("startime",TimeString);
